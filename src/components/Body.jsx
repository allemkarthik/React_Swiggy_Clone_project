...
const Body = () => {
  ...
  return listofrestro.length == 0 ? (
    ...
    <div>
      <div className="mx-auto w-full md:w-[80%] lg:w-[80%] my-14">
        ...
        <div className="flex justify-evenly">
          <div><img src={biryani} alt="" /></div>
          <div><img src={cakes} alt="" /></div>
          <div><img src={pizzas} alt="" /></div>
          <div><img src={icecream} alt="" /></div>
    ...
    <div className="body mx-auto w-full md:w-[80%] lg:w-[80%] ">
      <h1 className="text-2xl font-bold">Restaurants with online food delivery in Banglore</h1>
      <div
        className="grid
    grid-cols-1
    sm:grid-cols-2
